            ...
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className={`rounded-3xl p-8 ${tone.panel}`}>
                ...
                <form className="mt-6 grid gap-4">
                  <div>
                    <label className={`text-xs font-semibold uppercase tracking-[0.2em] ${tone.muted}`}>Your Name</label>
                    <input className={`mt-2 h-12 w-full rounded-xl px-4 text-sm ${tone.input}`} placeholder="John Doe" />
                  </div>
                  <div>
                    <label className={`text-xs font-semibold uppercase tracking-[0.2em] ${tone.muted}`}>Email Address</label>
                    <input className={`mt-2 h-12 w-full rounded-xl px-4 text-sm ${tone.input}`} placeholder="john@example.com" type="email" />
                  </div>
                  <div>
                    <label className={`text-xs font-semibold uppercase tracking-[0.2em] ${tone.muted}`}>Subject</label>
                    <select className={`mt-2 h-12 w-full rounded-xl px-4 text-sm ${tone.input}`}>
                      <option>Business Onboarding</option>
                  ...
                  <div>
                    <label className={`text-xs font-semibold uppercase tracking-[0.2em] ${tone.muted}`}>Message</label>
                    <textarea className={`mt-2 min-h-[180px] w-full rounded-2xl px-4 py-3 text-sm ${tone.input}`} placeholder="Tell us more about your inquiry..." />
                  </div>
